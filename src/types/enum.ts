...
export enum EMagicMouseTriggers {
  ONE_FINGER_TAP = 1,
  ONE_FINGER_TAP_LEFT = 2,
  ONE_FINGER_TAP_RIGHT = 3,
  ONE_FINGER_TAP_MIDDLE_CLICK = 23,
  ONE_FINGER_TAP_MIDDLE = 24,
  ONE_FINGER_TAP_ABOVE_APPLE = 32,
  SCROLL_UP = 18, // @TODO: add notice that modifier is needed
  SCROLL_DOWN = 19, // @TODO: add notice that modifier is needed
  ONE_FINGER_SWIPE_UP = 34,
  ONE_FINGER_SWIPE_DOWN = 33,
  ONE_FINGER_SWIPE_LEFT = 35,
  ONE_FINGER_SWIPE_RIGHT = 36,
  TWO_FINGER_TAP = 2,
  TWO_FINGER_DOUBLE_TAP = 44,
  PINCH_IN = 15,
  PINCH_OUT = 14,
  TWO_FINGER_SWIPE_RIGHT = 6,
  TWO_FINGER_SWIPE_LEFT = 5,
  TWO_FINGER_SWIPE_DOWN = 8,
  TWO_FINGER_SWIPE_UP = 7,
  TWO_FINGER_CLICK = 20,
  THREE_FINGER_SWIPE_DOWN = 12,
  THREE_FINGER_SWIPE_UP = 13,
  THREE_FINGER_CLICK = 21,
  THREE_FINGER_DOUBLE_TAP = 45,
  THREE_FINGER_TAP = 9,
  TIP_TAP_RIGHT = 17,
  TIP_TAP_LEFT = 16,
  TIP_SWIPE_LEFT_FINGER_DOWN = 41,
  TIP_SWIPE_LEFT_FINGER_UP = 42,
  THREE_FINGER_TIP_TAP_RIGHT = 31,
  THREE_FINGER_TIP_TAP_MIDDLE = 37,
  THREE_FINGER_TIP_TAP_LEFT = 30,
  THREE_FINGER_SWIPE_RIGHT = 11,
  THREE_FINGER_SWIPE_LEFT = 10,
  TWO_FINGER_TOUCH_TOP = 38,
  ONE_FINGER_TOUCH_TOP = 40,
  FOUR_FINGER_SWIPE_RIGHT = 29,
  FOUR_FINGER_SWIPE_LEFT = 28,
  FOUR_FINGER_SWIPE_DOWN = 26,
  FOUR_FINGER_SWIPE_UP = 27,
  FOUR_FINGER_CLICK = 25,
  THREE_FINGER_TOUCH_TOP = 39,
}