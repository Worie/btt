...
To get started - install BetterTouchTool from here. If you need help visit ABCD. Then, simply click this link
...
Alright! Time to verify whether you made it work :) Try to play with some buttons below:
...
You can [edit this page on GitHub](https://github.com/Worie/btt/blob/master/docs/guide/getting-started.md).